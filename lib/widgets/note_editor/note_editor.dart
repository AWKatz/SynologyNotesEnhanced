    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Both rows get a fixed height so the meta bar is the same size
          // on every note — without it, a Chip/button-less row collapses to
          // its intrinsic (shorter) height while a row with tags or a wider
          // control stretches taller, so the bar visibly jumped in height
          // from note to note.
          SizedBox(
            height: 20,
            child: Row(
                  ...
                  itemBuilder: (context) => [
                    ...
                    PopupMenuItem(
                      ...
                      child: ListTile(
                        ...
                        title:
                            Text(note.isFavorite ? 'Unfavorite' : 'Favourite'),
                        contentPadding: EdgeInsets.zero,
                      ),
                    ),
                    PopupMenuItem(
                    ...
                    switch (value) {
                      ...
                      case 'favorite':
                        ...
                        try {
                          ...
                          if (context.mounted) {
                            AppToast.error(
                                context, 'Could not update favorite.');
                          }
                        }
                      case 'color':
                      ...
                      case 'history':
                        showDialog<void>(
                          context: context,
                          builder: (context) =>
                              _VersionHistoryDialog(note: note),
                        );
                    }
                  },
                ),
